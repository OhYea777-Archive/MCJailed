 ...
 */
package com.mcjailed.libs.org.apache.commons.io.monitor;
...
import com.mcjailed.libs.org.apache.commons.io.IOCase;
import com.mcjailed.libs.org.apache.commons.io.comparator.NameFileComparator;
 ...
 * <ul>
 *   <li>Create {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationListener} implementation(s) that process
 *      the file/directory create, change and delete events</li>
 *   <li>Register the listener(s) with a {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationObserver} for
 *       the appropriate directory.</li>
 *   <li>Either register the observer(s) with a {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationMonitor} or
 *       run manually.</li>
 * </ul>
 *
 * <h2>Basic Usage</h2>
 * Create a {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationObserver} for the directory and register the listeners:
 * <pre>
 ...
 *      observer.finish();
 * </pre>
 * Alternatively, register the oberver(s) with a {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationMonitor},
 ...
 * in a root directory called "src" you could set up a {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationObserver} in the following
 * way:
 * <pre>
 *      // Create a FileFilter
 ...
 *
 * <h2>FileEntry</h2>
 * {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileEntry} represents the state of a file or directory, capturing
 * {@link java.io.File} attributes at a point in time. Custom implementations of
 * {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileEntry} can be used to capture additional properties that the
 * basic implementation does not support. The {@link com.mcjailed.libs.org.apache.commons.io.monitor.FileEntry#refresh(java.io.File)}
 ...
 *
 * @see com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationListener
 * @see com.mcjailed.libs.org.apache.commons.io.monitor.FileAlterationMonitor
